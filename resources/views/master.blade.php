...
<html lang="en">
  ...
  <link rel="icon" href="{{ Options::getvalue('siteFavIcon') }}" type="image/png" sizes="16x16">
  ...
  @yield('custom-header-scripts')
  </head>
  <body>
  <!-- Start Page Loading -->
  <div class="loading"><img src="{{URL::asset('image/loading.gif')}}" alt="loading-img"></div>
  <!-- End Page Loading -->
 <!-- //////////////////////////////////////////////////////////////////////////// --> 
  <!-- START TOP -->
  <div id="top" class="clearfix">
   ...
   <!--  <ul class="topmenu">
    ...
    <li class="dropdown link">
      <a href="#" data-toggle="dropdown" class="dropdown-toggle profilebox"><b>{{Auth::user()->full_name}}</b><span class="caret"></span></a>
        <ul class="dropdown-menu dropdown-menu-list dropdown-menu-right">
          ...
          <li><a href="{{URL::to('admin/changepassword')}}"><i class="fa falist fa-key"></i> Change Password</a></li>
          <li><a href="{{URL::to('logout')}}"><i class="fa falist fa-power-off"></i> Logout</a></li>
        </ul>
    </li>
