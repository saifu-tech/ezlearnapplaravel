...
<div ng-app="ezTrack" ng-controller="ezTrackCntrl" class="container-default">
    <div class="well">
        <form ng-submit="addData()">
            <div class="row">
                <div class="col-md-4">
                    <label>Select Template <?php echo e(Auth::User()->full_name); ?></label>
                </div>
            ...
            <div class="row" ng-show="form.revenuedetails">
                ...
                <div class="form-group  col-md-4">
                    ...
                    <?php /* <input type="text" class="form-control"    ng-model="form.revenue.start">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8 col-md-offset-4">
                            <div class="form-group " ng-repeat="stud in form.studentList track by $index">
                                ...
                                <?php /* <div class="col-md-6" ng-show="form.studentsoptions == false">
            ...
            <div class="row"  ng-show="form.yaxis">
                ...
                <div class="form-group col-md-6" >
                    <label><span><?php echo e(Auth::User()->full_name); ?></span></label>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-8 col-md-offset-4">
...
<script>
    ...
    app.controller('ezTrackCntrl', function($scope,$http,$timeout) {
        ...
        $scope.optionlistdata =  <?php echo json_encode($options); ?>;
        $scope.option = [];
        $scope.form = {} ;
        $scope.options = '';
