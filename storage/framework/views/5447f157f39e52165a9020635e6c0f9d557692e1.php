...
<div class="row add_row"  style="display: none">
  <div class="col-md-12 col-lg-12">
        ...
        <div class="panel-title">
          ...
          <ul class="panel-tools">
            ...
            <div class="panel-body">
              <?php echo e(Form::open(['url'=>'admin/daily/tasks/add/post','class'=>'form-horizontal'])); ?>

              <?php if(Session::has('success')): ?> <?php echo HTML::display_success('success'); ?> <?php endif; ?>


              <div class="form-group">
                  <?php echo e(Form::label('taskTemplate','Select Template',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                  <?php echo e(Form::select('taskTemplate',$templates,'',['class'=>'form-control','placeholder'=>'Select Template'])); ?>

                  <?php if($errors->add->has('taskTemplate')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->add->first('taskTemplate')); ?>
                ...
                <div class="form-group">
                  <?php echo e(Form::label('taskType','Task Type *',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                  <?php echo e(Form::select('taskType',['daily'=>'Daily Task','weekly'=>'Weekly Task','monthly'=>'Monthly Task'],'daily',['class'=>'form-control'])); ?>

                  <?php if($errors->add->has('taskType')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->add->first('taskType')); ?>
              ...
              <div class="form-group">
                  <?php echo e(Form::label('groupName','Group Name*',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                  <?php echo e(Form::text('groupName','',['class'=>'form-control'])); ?>

                  <?php if($errors->add->has('groupName')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->add->first('groupName')); ?>
                ...
                <div class="form-group">
                  <?php echo e(Form::label('taskName','Task Name *',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                    <?php echo e(Form::text('taskName','',['class'=>'form-control','min'=>7])); ?>

                    <?php if($errors->add->has('taskName')): ?> 
                      <div class="validation-error errorActive asterisk">
                         <?php echo e($errors->add->first('taskName')); ?>
                ...
                <div class="form-group">
                  <?php echo e(Form::label('startDate','Start Date *',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                    <?php echo e(Form::text('startDate','',['class'=>'form-control startDate'])); ?>

                    <?php if($errors->add->has('startDate')): ?> 
                      <div class="validation-error errorActive asterisk">
                         <?php echo e($errors->add->first('startDate')); ?>
                ...
                <div class="form-group">
                  <?php echo e(Form::label('endDate','End Date *',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                    <?php echo e(Form::text('endDate','',['class'=>'form-control endDate'])); ?>

                    <?php if($errors->add->has('endDate')): ?> 
                      <div class="validation-error errorActive asterisk">
                         <?php echo e($errors->add->first('endDate')); ?>
                ...
                <div class="form-group">
                  <?php echo e(Form::label('students','Students',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                  <?php echo e(Form::select('students[]',$students,'',['class'=>'form-control','placeholder'=>'Select Students','multiple','id'=>'students'])); ?>

                  <?php if($errors->add->has('students')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->add->first('students')); ?>
                ...
                <div class="form-group cloneTask">
                  <?php echo e(Form::label('Options','Options *',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                  <?php echo e(Form::text('options[]','',['class'=>'form-control', 'autocomplete'=>'off'])); ?>
                ...
                <div class="form-group cloneStatus">
                  ...
                  <div class="col-sm-6">
                  <?php echo e(Form::text('status[]','',['class'=>'form-control taskStatus', 'autocomplete'=>'off'])); ?>

                 </div>
                 <div class="col-sm-2">
                  <?php echo e(Form::select('color[]',[''=>'Color','#00ff00'=>'Green','#ffff00'=>'Yellow','#ff0000'=>'Red','#5acbff'=>'Blue', '#636161'=>'Gray'],'',['class'=>'form-control statusColor'])); ?>
                ...
                <div class="form-group dailyTaskDiv">
                  <?php echo e(Form::label('dailyDay','Select Day *',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                    <?php echo e(Form::checkbox('dailyDay[]',1,true,['class'=>'dailyDay'])); ?> Monday&nbsp;&nbsp;
                    <?php echo e(Form::checkbox('dailyDay[]',2,true,['class'=>'dailyDay'])); ?> Tuesday&nbsp;&nbsp;
                    <?php echo e(Form::checkbox('dailyDay[]',3,true,['class'=>'dailyDay'])); ?> Wednesday&nbsp;&nbsp;
                    <?php echo e(Form::checkbox('dailyDay[]',4,true,['class'=>'dailyDay'])); ?> Thursday&nbsp;&nbsp;
                    <?php echo e(Form::checkbox('dailyDay[]',5,true,['class'=>'dailyDay'])); ?> Friday&nbsp;&nbsp;
                    <?php echo e(Form::checkbox('dailyDay[]',6,true,['class'=>'dailyDay'])); ?> Saturday&nbsp;&nbsp;
                    <?php echo e(Form::checkbox('dailyDay[]',7,true,['class'=>'dailyDay'])); ?> Sunday&nbsp;&nbsp;
                  </div>
                  <?php if($errors->add->has('dailyDay')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->add->first('dailyDay')); ?>
                ...
                <div class="form-group weeklyTaskDiv" style="display:none;">
                  <?php echo e(Form::label('weeklyDay','Select Day *',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                    <?php echo e(Form::select('weeklyDay',[1=>'Monday',2=>'Tuesday',3=>'Wednesday',4=>'Thursday',5=>'Friday',6=>'Saturday',7=>'Sunday'],'',['class'=>'weeklyDay','placeholder'=>'Select Day'])); ?>

                  </div>
                  <?php if($errors->add->has('weeklyDay')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->add->first('weeklyDay')); ?>
                ...
                <div class="form-group monthlyTaskDiv" style="display:none;">
                  <?php echo e(Form::label('monthlyDay','Select Day *',['class'=>'col-sm-2 control-label'])); ?>

                  <div class="col-sm-8">
                    <?php echo e(Form::select('monthlyDay',$day,'',['class'=>'monthlyDay','placeholder'=>'Select Day'])); ?>

                  </div>
                  <?php if($errors->add->has('monthlyDay')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->add->first('monthlyDay')); ?>
                ...
                <div class="form-group templateDiv">
                  ...
                  <div class="col-sm-8">
                  <?php echo e(Form::checkbox('template','yes',false,['class'=>''])); ?>&nbsp; Make this template
                 </div>
                </div>
                ...
                <div class="col-sm-8">
                <?php echo e(Form::submit('Save',['class'=>'btn btn-default saveTask'])); ?>

                <?php echo e(Form::reset('Cancel',['class'=>'btn btn-info'])); ?>
      ...
      <?php if(Session::has('editsuccess')): ?> <?php echo HTML::display_success('editsuccess'); ?> <?php endif; ?>
      <div class="row edit_row" style="display: none">
        <div class="col-md-12 col-lg-12">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <?php echo e(Form::open(['url'=>'admin/daily/tasks/edit/post','class'=>'form-horizontal'])); ?>
                ...
                <div class="form-group">
                  ...
                  <?php if($errors->edit->has('taskType')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->edit->first('taskType')); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                  <?php echo e(Form::text('groupName','',['class'=>'form-control editGroupName'])); ?>

                  <?php if($errors->edit->has('groupName')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->edit->first('groupName')); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <?php echo e(Form::text('taskName','',['class'=>'form-control editTaskName'])); ?>

                    <?php if($errors->edit->has('taskName')): ?> 
                      <div class="validation-error errorActive asterisk">
                         <?php echo e($errors->edit->first('taskName')); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <?php echo e(Form::text('startDate','',['class'=>'form-control editStartDate'])); ?>

                    <?php if($errors->edit->has('startDate')): ?> 
                      <div class="validation-error errorActive asterisk">
                         <?php echo e($errors->edit->first('startDate')); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <?php echo e(Form::text('endDate','',['class'=>'form-control editEndDate'])); ?>

                    <?php if($errors->edit->has('endDate')): ?> 
                      <div class="validation-error errorActive asterisk">
                         <?php echo e($errors->edit->first('endDate')); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                  <?php echo e(Form::select('students[]',$students,'',['class'=>'form-control editStudents','placeholder'=>'Select Students','multiple','id'=>'students'])); ?>

                  <?php if($errors->edit->has('students')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->edit->first('students')); ?>
                ...
                <div class="optionsDiv">
                  ...
                  <div class="col-sm-8">
                  <?php echo e(Form::text('options[]','',['class'=>'form-control'])); ?>
                ...
                <div class="form-group cloneStatus">
                  ...
                  <div class="col-sm-6">
                  <?php echo e(Form::text('status[]','',['class'=>'form-control taskStatus'])); ?>
                ...
                <div class="form-group dailyTaskDiv" style="display:none;">
                  ...
                  <?php if($errors->edit->has('dailyDay')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->edit->first('dailyDay')); ?>
                ...
                <div class="form-group weeklyTaskDiv" style="display:none;">
                  ...
                  <?php if($errors->edit->has('weeklyDay')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->edit->first('weeklyDay')); ?>
                ...
                <div class="form-group monthlyTaskDiv" style="display:none;">
                  ...
                  <?php if($errors->edit->has('monthlyDay')): ?> 
                    <div class="validation-error errorActive asterisk">
                       <?php echo e($errors->edit->first('monthlyDay')); ?>
                ...
                <?php echo e(Form::hidden('editId','',['class'=>'editId'])); ?>
                ...
                <div class="col-sm-8">
                <?php echo e(Form::submit('Save',['class'=>'btn btn-default updateTask'])); ?>
            ...
            <table id="example0" class="table display">
                ...
                <tbody>
                  ...
                  <?php foreach($records as $record): ?>
                    ...
                    ?>
                    <tr class='taskrow<?php echo e($record->serialNo); ?>'>
                      <td><?php echo e(++$i); ?></td>
                      <td><?php echo e($record->groupName); ?></td>
                      <td><?php echo e($record->taskName); ?></td>
                      <td><?php echo e($students); ?></td>
                      <td><?php echo e(date($dateFormat,strtotime($record->startDate))); ?></td>
                      <td><?php echo e(date($dateFormat,strtotime($record->endDate))); ?></td>
                      <td><?php echo e(ucfirst($record->status)); ?></td>
                      <td><a href="javascript:void(0)" class="edit" editId="<?php echo e($record->serialNo); ?>"><i class="fa fa-pencil-square-o"></i></a></td>
                      <!-- <?php if($record->status=='active'): ?>
                        <td><a href="javascript:void(0)" class="closeTask" data-id="<?php echo e($record->serialNo); ?>">Close</a></td>
                        
                      <?php else: ?>
                        <td>Closed on <?php echo e(date($dateFormat,strtotime($record->endDate))); ?></td>
                        <td>&nbsp;&nbsp;</td>
                      <?php endif; ?> -->
                      <td><div class="checkbox"><input type="checkbox" id="checkbox<?php echo e($i); ?>" class="selectRecords" data-record="<?php echo e($record->serialNo); ?>"><label for="checkbox<?php echo e($i); ?>"></label></div></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
            </table>
  ...
  <div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <?php echo e(Form::hidden('closeSerialNo','',['class'=>'closeSerialNo'])); ?>
...
<!-- END CONTAINER -->
  ...
  $(document).on('change','#taskTemplate',function(){
    ...
    if(serialNo!=''){
        $.ajax({
          type: 'POST',
           url: '<?php echo e(URL::action('TestController@gettemplatedetails')); ?>',
  ...
  $(document).on('click','.closeTaskSubmit',function(){
    $('.errorMessage,.successMessage').hide();
     ...
     $.ajax({
        type: 'POST',
       url: '<?php echo e(URL::action('TestController@closetaskpost')); ?>',
  ...
  $(document).on('click','.deleteButton',function(){
    ...
    ids=JSON.stringify(ids);
     $.ajax({
        type: 'POST',
       url: '<?php echo e(URL::action('TestController@deletedailytaskspost')); ?>',
       data: {ids:ids},
       dataType: 'json',
       headers: { 'X-XSRF-Token': $('meta[name="_token"]').attr('content'), },
       success: function(data){
  ...
  $(document).on('click','.edit',function(){
    ...
    $.ajax({
      ...
      data: {editId},
      dataType:'JSON',
      url: '<?php echo e(URL::action('TestController@getdailytaskspost')); ?>',
      headers: { 'X-XSRF-Token': $('meta[name="_token"]').attr('content'), },
      success:function(data){
        console.log(data);
  ...
  function getcountrystudents(panel){
    ...
    if(country!=''){
      $.ajax({
        ...
        dataType:'JSON',
        url: '<?php echo e(URL::action('TestController@getcountrystudents')); ?>',
        headers: { 'X-XSRF-Token': $('meta[name="_token"]').attr('content'), },
        success:function(data){
          console.log(data);
